            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <?php if($num_results_berhutang_lunas>0){ ?>
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                    <?php $no=1; while($row_berhutang_lunas = $result_berhutang_lunas->fetch_assoc()){extract($row_berhutang_lunas); ?>
                                        <tr>
                                            <td><?php echo "$no" ?></td>
                                            <td><?php echo "$nama_berhutang_lunas" ?></td>
                                            <td><?php echo "$status_berhutang_lunas" ?></td>
                                            <td><?php echo "$tanggal_berhutang_lunas" ?></td>
                                            <td><?php echo "$tanggal_lunas_berhutang_lunas" ?></td>
                                            <td>
                                                <table width="90">
                                                    <tr>
                                                        <td>Rp</td>
                                                        <td align="right"><?php echo number_format("$jumlah_berhutang_lunas",0,",",".") ?></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
