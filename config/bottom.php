...
<!-- Select2 -->
<script src="../src/dashboard/select2/dist/js/select2.full.min.js"></script>
<!-- InputMask -->
...
<!-- date-range-picker -->
<script src="../src/dashboard/moment/min/moment.min.js"></script>
<script src="../src/dashboard/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- bootstrap datepicker -->
<script src="../src/dashboard/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- bootstrap color picker -->
<script src="../src/dashboard/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js"></script>
